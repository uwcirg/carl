...
class Coding(Resource):
    ...
    def from_fhir(cls, data):
        ...
        return cls(
            code=data["code"], system=data["system"], display=data.get("display")
        )

    def __eq__(self, other):
        """Logical equals operator - needed for set functionality"""
        return self._fields.get("code") == other._fields.get(
            "code"
        ) and self._fields.get("system") == other._fields.get("system")
